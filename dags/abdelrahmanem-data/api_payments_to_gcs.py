import os, requests, pendulum, pandas as pd
from airflow.decorators import dag, task
from airflow.operators.empty import EmptyOperator
from airflow.providers.google.cloud.transfers.local_to_gcs import LocalFilesystemToGCSOperator

BUCKET = "ready-labs-postgres-to-gcs"
DST    = "abdelrahmanem-data/payments.csv" 
API_URL = "https://payments-table-834721874829.europe-west1.run.app"
TMP    = "/tmp/payments.csv"

@dag(dag_id="extract_order_payments_csv_to_gcs", schedule="@daily",
     start_date=pendulum.datetime(2025,8,1,tz="UTC"), catchup=False, tags=["api","csv","gcs"])
def dag_extract_payments():
    ...
    upload = LocalFilesystemToGCSOperator(
        ...
        dst=DST,
        bucket=BUCKET,
        replace=True,                # overwrite نفس الملف
